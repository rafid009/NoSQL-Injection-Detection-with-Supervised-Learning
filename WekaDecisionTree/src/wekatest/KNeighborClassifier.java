...
/**
 * Created by ASUS on 11/22/5017.
 */
public class KNeighborClassifier {
    public static void kFoldValidationK(Instances newData) throws IOException, Exception
    {
        BufferedWriter output = null;
        File file = new File("knn_kFold_stat.txt");
        ...
        System.out.println("DBG_KNN_END\n\n");
